...
export async function GET() {
  const baseUrl = 'https://roadmap.tools.startvest.ai';
  const pages = getAllPages();

  const content = `# Roadmap Planner - AI Content Manifest

> This file tells AI agents about available content in machine-readable formats.

## About This Site

Roadmap Planner is a free visual product roadmap builder.
Create beautiful roadmaps with timeline views, feature cards, and status indicators.
