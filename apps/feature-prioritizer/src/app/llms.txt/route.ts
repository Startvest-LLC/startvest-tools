...
export async function GET() {
  const baseUrl = 'https://prioritize.tools.startvest.ai';
  const pages = getAllPages();

  const content = `# Feature Prioritization Matrix - AI Content Manifest

> This file tells AI agents about available content in machine-readable formats.

## About This Site

Feature Prioritization Matrix is a free RICE score calculator for product teams.
Score features by Reach, Impact, Confidence, and Effort to find quick wins and big bets.
