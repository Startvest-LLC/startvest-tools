...
export async function GET() {
  const baseUrl = 'https://runway.tools.startvest.ai';
  const pages = getAllPages();

  const content = `# Startup Runway Calculator - AI Content Manifest

> This file tells AI agents about available content in machine-readable formats.

## About This Site

Startup Runway Calculator is a free tool that helps founders calculate how long their funding will last.
Enter your cash, burn rate, revenue, and growth rate to see your runway projection.
