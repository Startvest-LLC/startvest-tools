...
export async function GET() {
  const baseUrl = 'https://persona.tools.startvest.ai';
  const pages = getAllPages();

  const content = `# User Persona Generator - AI Content Manifest

> This file tells AI agents about available content in machine-readable formats.

## About This Site

User Persona Generator is a free tool for creating detailed user personas for product development.
Build comprehensive personas with demographics, goals, pain points, and behaviors.
